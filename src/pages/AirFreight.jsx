...
import airfreight from "../assets/images/sliderplane.jpg"
import redplane from "../assets/images/sliderplane.jpg"
...
const AirFreight = () => {
    ...
    return (
        <div className='overflow-x-hidden'>
            <div className=''>
                <img src={airfreight} alt='contact' className='relative h-[650px] w-full' />
                <h1 className='absolute top-[65%] lg:left-[180px] text-white text-6xl font-bold'>Air Freight</h1>
            </div>

            <div className='w-full lg:h-[1600px] px-[20px]'>
                <div className='flex flex-col lg:flex-row bg-white w-[1095px] h-[100%] lg:ml-[190px] lg:my-10'>
                    <div className='air__left'>
                        <div className="flex flex-col pt-10 lg:ml-[30px] ml-[10px] pl-10 bg-orange-600 w-[300px] h-[350px] mt-10">
                    ...
                    <div className='air__right'>
                        ...
                        <p className='text-gray-400 w-[350px] lg:w-full'>
                            Our airfreight staff attaches great importance to customizing the booking process for our customers. That’s why we strive to find the air freight solution that best suits your needs.
                        </p>
                        <br />

                        <p className='text-gray-400 w-[350px] lg:w-full'>
                            We have more than twenty years of combined experience. During that time, we’ve become expert in freight transportation by air and all its related services. We work closely with all major airlines from the USA and China. Ongoing negotiations ensure that we always have the required cargo space and the ability to offer you competitive rates – even during the high season.
                        </p>
                        <br />
                        <p className='text-gray-400 w-[350px] lg:w-full'>
                            We ensure your packages are insured to safeguard your investments.
                        </p>
                        ...
                        <p className='text-gray-400 mb-4 w-[320px] lg:w-full'>
                            At BoxGiant, we are committed to speed, customer service and transparency. We offer an array of free ad-on services to enhance your cost-saving experience with us. Our price calculator and fixed prices offers you the ability to accurately forecast your shipping expenses with no hidden or shock charges.
                        </p>
